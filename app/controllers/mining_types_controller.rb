class MiningTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mining_type.save
        format.html { redirect_to mining_type_url(@mining_type), notice: "Tipo de Mineração foi criado com sucesso!!"}
  ...
  def update
    respond_to do |format|
      if @mining_type.update(mining_type_params)
        format.html { redirect_to mining_type_url(@mining_type), notice: "Tipo de Mineração foi atualizado com sucesso!!" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mining_types_url, notice: "Tipo de Mineração foi excluido com sucesso!!" }
